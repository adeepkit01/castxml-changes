...
def register_Ns3QueueDisc_methods(root_module, cls):
    ...
    cls.add_method('GetWakeMode', 
                   ...
                   [], 
                   is_const=True, is_virtual=True)
    ## queue-disc.h (module 'traffic-control'): void ns3::QueueDisc::SetParentDropCallback(ns3::QueueDisc::ParentDropCallback cb) [member function]
...
def register_Ns3RedQueueDiscStats_methods(root_module, cls):
    ## red-queue-disc.h (module 'traffic-control'): ns3::RedQueueDisc::Stats() [constructor]
    cls.add_constructor([])
    ## red-queue-disc.h (module 'traffic-control'): ns3::RedQueueDisc::Stats(ns3::RedQueueDisc::Stats const & arg0) [constructor]
...
def register_Ns3PieQueueDiscStats_methods(root_module, cls):
    ## pie-queue-disc.h (module 'traffic-control'): ns3::PieQueueDisc::Stats() [constructor]
    cls.add_constructor([])
    ## pie-queue-disc.h (module 'traffic-control'): ns3::PieQueueDisc::Stats(ns3::PieQueueDisc::Stats const & arg0) [constructor]
